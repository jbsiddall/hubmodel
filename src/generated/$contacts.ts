...
const SelectArgValidator = z.record(
  z.union([
    z.literal("company_size"),
    z.literal("date_of_birth"),
    z.literal("days_to_close"),
    z.literal("degree"),
    z.literal("field_of_study"),
    z.literal("first_conversion_date"),
    z.literal("first_conversion_event_name"),
    z.literal("first_deal_created_date"),
    z.literal("gender"),
    z.literal("graduation_date"),
    z.literal("hs_additional_emails"),
    z.literal("hs_all_assigned_business_unit_ids"),
    z.literal("hs_all_contact_vids"),
    z.literal("hs_analytics_first_touch_converting_campaign"),
    z.literal("hs_analytics_last_touch_converting_campaign"),
    z.literal("hs_avatar_filemanager_key"),
    z.literal("hs_buying_role"),
    z.literal("hs_calculated_form_submissions"),
    z.literal("hs_calculated_merged_vids"),
    z.literal("hs_calculated_mobile_number"),
    z.literal("hs_calculated_phone_number"),
    z.literal("hs_calculated_phone_number_area_code"),
    z.literal("hs_calculated_phone_number_country_code"),
    z.literal("hs_calculated_phone_number_region_code"),
    z.literal("hs_clicked_linkedin_ad"),
    z.literal("hs_content_membership_email"),
    z.literal("hs_content_membership_email_confirmed"),
    z.literal("hs_content_membership_follow_up_enqueued_at"),
    z.literal("hs_content_membership_notes"),
    z.literal("hs_content_membership_registered_at"),
    z.literal("hs_content_membership_registration_domain_sent_to"),
    z.literal("hs_content_membership_registration_email_sent_at"),
    z.literal("hs_content_membership_status"),
    z.literal("hs_conversations_visitor_email"),
    z.literal("hs_count_is_unworked"),
    z.literal("hs_count_is_worked"),
    z.literal("hs_created_by_conversations"),
    z.literal("hs_created_by_user_id"),
    z.literal("hs_createdate"),
    z.literal("hs_date_entered_customer"),
    z.literal("hs_date_entered_evangelist"),
    z.literal("hs_date_entered_lead"),
    z.literal("hs_date_entered_marketingqualifiedlead"),
    z.literal("hs_date_entered_opportunity"),
    z.literal("hs_date_entered_other"),
    z.literal("hs_date_entered_salesqualifiedlead"),
    z.literal("hs_date_entered_subscriber"),
    z.literal("hs_date_exited_customer"),
    z.literal("hs_date_exited_evangelist"),
    z.literal("hs_date_exited_lead"),
    z.literal("hs_date_exited_marketingqualifiedlead"),
    z.literal("hs_date_exited_opportunity"),
    z.literal("hs_date_exited_other"),
    z.literal("hs_date_exited_salesqualifiedlead"),
    z.literal("hs_date_exited_subscriber"),
    z.literal("hs_document_last_revisited"),
    z.literal("hs_email_bad_address"),
    z.literal("hs_email_customer_quarantined_reason"),
    z.literal("hs_email_domain"),
    z.literal("hs_email_hard_bounce_reason"),
    z.literal("hs_email_hard_bounce_reason_enum"),
    z.literal("hs_email_quarantined"),
    z.literal("hs_email_quarantined_reason"),
    z.literal("hs_email_recipient_fatigue_recovery_time"),
    z.literal("hs_email_sends_since_last_engagement"),
    z.literal("hs_emailconfirmationstatus"),
    z.literal("hs_facebook_ad_clicked"),
    z.literal("hs_facebook_click_id"),
    z.literal("hs_facebookid"),
    z.literal("hs_feedback_last_nps_follow_up"),
    z.literal("hs_feedback_last_nps_rating"),
    z.literal("hs_feedback_last_survey_date"),
    z.literal("hs_feedback_show_nps_web_survey"),
    z.literal("hs_first_engagement_object_id"),
    z.literal("hs_first_outreach_date"),
    z.literal("hs_first_subscription_create_date"),
    z.literal("hs_google_click_id"),
    z.literal("hs_googleplusid"),
    z.literal("hs_has_active_subscription"),
    z.literal("hs_ip_timezone"),
    z.literal("hs_is_contact"),
    z.literal("hs_is_unworked"),
    z.literal("hs_last_sales_activity_date"),
    z.literal("hs_last_sales_activity_timestamp"),
    z.literal("hs_last_sales_activity_type"),
    z.literal("hs_lastmodifieddate"),
    z.literal("hs_latest_sequence_ended_date"),
    z.literal("hs_latest_sequence_enrolled"),
    z.literal("hs_latest_sequence_enrolled_date"),
    z.literal("hs_latest_sequence_finished_date"),
    z.literal("hs_latest_sequence_unenrolled_date"),
    z.literal("hs_latest_source_timestamp"),
    z.literal("hs_latest_subscription_create_date"),
    z.literal("hs_lead_status"),
    z.literal("hs_legal_basis"),
    z.literal("hs_linkedin_ad_clicked"),
    z.literal("hs_linkedinid"),
    z.literal("hs_marketable_reason_id"),
    z.literal("hs_marketable_reason_type"),
    z.literal("hs_marketable_status"),
    z.literal("hs_marketable_until_renewal"),
    ...
    z.literal("hs_predictivecontactscore_v2"),
    z.literal("hs_predictivescoringtier"),
    z.literal("hs_read_only"),
    z.literal("hs_sa_first_engagement_date"),
    z.literal("hs_sa_first_engagement_descr"),
    z.literal("hs_sa_first_engagement_object_type"),
    z.literal("hs_sales_email_last_clicked"),
    z.literal("hs_sales_email_last_opened"),
    z.literal("hs_searchable_calculated_international_mobile_number"),
    z.literal("hs_searchable_calculated_international_phone_number"),
    z.literal("hs_searchable_calculated_mobile_number"),
    z.literal("hs_searchable_calculated_phone_number"),
    z.literal("hs_sequences_actively_enrolled_count"),
    z.literal("hs_sequences_enrolled_count"),
    z.literal("hs_sequences_is_enrolled"),
    z.literal("hs_source_object_id"),
    z.literal("hs_source_portal_id"),
    z.literal("hs_testpurge"),
    z.literal("hs_testrollback"),
    z.literal("hs_time_between_contact_creation_and_deal_close"),
    z.literal("hs_time_between_contact_creation_and_deal_creation"),
    z.literal("hs_time_in_customer"),
    z.literal("hs_time_in_evangelist"),
    z.literal("hs_time_in_lead"),
    z.literal("hs_time_in_marketingqualifiedlead"),
    z.literal("hs_time_in_opportunity"),
    z.literal("hs_time_in_other"),
    z.literal("hs_time_in_salesqualifiedlead"),
    z.literal("hs_time_in_subscriber"),
    z.literal("hs_time_to_first_engagement"),
    z.literal("hs_time_to_move_from_lead_to_customer"),
    z.literal("hs_time_to_move_from_marketingqualifiedlead_to_customer"),
    z.literal("hs_time_to_move_from_opportunity_to_customer"),
    z.literal("hs_time_to_move_from_salesqualifiedlead_to_customer"),
    z.literal("hs_time_to_move_from_subscriber_to_customer"),
    z.literal("hs_timezone"),
    z.literal("hs_twitterid"),
    ...
    z.literal("hs_v2_cumulative_time_in_customer"),
    z.literal("hs_v2_cumulative_time_in_evangelist"),
    z.literal("hs_v2_cumulative_time_in_lead"),
    z.literal("hs_v2_cumulative_time_in_marketingqualifiedlead"),
    z.literal("hs_v2_cumulative_time_in_opportunity"),
    z.literal("hs_v2_cumulative_time_in_other"),
    z.literal("hs_v2_cumulative_time_in_salesqualifiedlead"),
    z.literal("hs_v2_cumulative_time_in_subscriber"),
    z.literal("hs_v2_date_entered_customer"),
    z.literal("hs_v2_date_entered_evangelist"),
    z.literal("hs_v2_date_entered_lead"),
    z.literal("hs_v2_date_entered_marketingqualifiedlead"),
    z.literal("hs_v2_date_entered_opportunity"),
    z.literal("hs_v2_date_entered_other"),
    z.literal("hs_v2_date_entered_salesqualifiedlead"),
    z.literal("hs_v2_date_entered_subscriber"),
    z.literal("hs_v2_date_exited_customer"),
    z.literal("hs_v2_date_exited_evangelist"),
    z.literal("hs_v2_date_exited_lead"),
    z.literal("hs_v2_date_exited_marketingqualifiedlead"),
    z.literal("hs_v2_date_exited_opportunity"),
    z.literal("hs_v2_date_exited_other"),
    z.literal("hs_v2_date_exited_salesqualifiedlead"),
    z.literal("hs_v2_date_exited_subscriber"),
    z.literal("hs_v2_latest_time_in_customer"),
    z.literal("hs_v2_latest_time_in_evangelist"),
    z.literal("hs_v2_latest_time_in_lead"),
    z.literal("hs_v2_latest_time_in_marketingqualifiedlead"),
    z.literal("hs_v2_latest_time_in_opportunity"),
    z.literal("hs_v2_latest_time_in_other"),
    z.literal("hs_v2_latest_time_in_salesqualifiedlead"),
    z.literal("hs_v2_latest_time_in_subscriber"),
    z.literal("hs_was_imported"),
    z.literal("hs_whatsapp_phone_number"),
    z.literal("hubspot_owner_assigneddate"),
    z.literal("ip_city"),
    z.literal("ip_country"),
    z.literal("ip_country_code"),
    z.literal("ip_latlon"),
    z.literal("ip_state"),
    z.literal("ip_state_code"),
    z.literal("ip_zipcode"),
    z.literal("job_function"),
    z.literal("lastmodifieddate"),
    z.literal("marital_status"),
    z.literal("military_status"),
    z.literal("num_associated_deals"),
    z.literal("num_conversion_events"),
    z.literal("num_unique_conversion_events"),
    z.literal("recent_conversion_date"),
    z.literal("recent_conversion_event_name"),
    z.literal("recent_deal_amount"),
    z.literal("recent_deal_close_date"),
    z.literal("relationship_status"),
    z.literal("school"),
    z.literal("seniority"),
    z.literal("start_date"),
    z.literal("total_revenue"),
    z.literal("work_email"),
    z.literal("firstname"),
    z.literal("hs_analytics_first_url"),
    z.literal("hs_email_delivered"),
    z.literal("hs_email_optout_227290470"),
    z.literal("hs_email_optout_227290476"),
    z.literal("twitterhandle"),
    z.literal("currentlyinworkflow"),
    z.literal("followercount"),
    z.literal("hs_analytics_last_url"),
    z.literal("hs_email_open"),
    z.literal("lastname"),
    z.literal("hs_analytics_num_page_views"),
    z.literal("hs_email_click"),
    z.literal("salutation"),
    z.literal("twitterprofilephoto"),
    z.literal("email"),
    z.literal("hs_analytics_num_visits"),
    z.literal("hs_email_bounce"),
    z.literal("hs_persona"),
    z.literal("hs_social_last_engagement"),
    z.literal("hs_analytics_num_event_completions"),
    z.literal("hs_email_optout"),
    z.literal("hs_social_twitter_clicks"),
    z.literal("mobilephone"),
    z.literal("phone"),
    z.literal("fax"),
    z.literal("hs_analytics_first_timestamp"),
    z.literal("hs_email_last_email_name"),
    z.literal("hs_email_last_send_date"),
    z.literal("hs_social_facebook_clicks"),
    z.literal("address"),
    z.literal("engagements_last_meeting_booked"),
    z.literal("engagements_last_meeting_booked_campaign"),
    z.literal("engagements_last_meeting_booked_medium"),
    z.literal("engagements_last_meeting_booked_source"),
    z.literal("hs_analytics_first_visit_timestamp"),
    z.literal("hs_email_last_open_date"),
    z.literal("hs_latest_meeting_activity"),
    z.literal("hs_sales_email_last_replied"),
    z.literal("hs_social_linkedin_clicks"),
    ...
    z.literal("num_notes"),
    z.literal("owneremail"),
    z.literal("ownername"),
    z.literal("surveymonkeyeventlastupdated"),
    z.literal("webinareventlastupdated"),
    z.literal("city"),
    z.literal("hs_analytics_last_timestamp"),
    z.literal("hs_email_last_click_date"),
    z.literal("hs_social_google_plus_clicks"),
    z.literal("hubspot_team_id"),
    z.literal("linkedinbio"),
    z.literal("twitterbio"),
    z.literal("hs_all_owner_ids"),
    z.literal("hs_analytics_last_visit_timestamp"),
    z.literal("hs_email_first_send_date"),
    z.literal("hs_social_num_broadcast_clicks"),
    z.literal("state"),
    z.literal("hs_all_team_ids"),
    z.literal("hs_analytics_source"),
    z.literal("hs_email_first_open_date"),
    z.literal("hs_latest_source"),
    z.literal("zip"),
    z.literal("country"),
    z.literal("hs_all_accessible_team_ids"),
    z.literal("hs_analytics_source_data_1"),
    z.literal("hs_email_first_click_date"),
    z.literal("hs_latest_source_data_1"),
    z.literal("linkedinconnections"),
    z.literal("hs_analytics_source_data_2"),
    z.literal("hs_email_is_ineligible"),
    z.literal("hs_language"),
    z.literal("hs_latest_source_data_2"),
    z.literal("kloutscoregeneral"),
    z.literal("hs_analytics_first_referrer"),
    z.literal("hs_email_first_reply_date"),
    z.literal("jobtitle"),
    z.literal("photo"),
    z.literal("hs_analytics_last_referrer"),
    z.literal("hs_email_last_reply_date"),
    z.literal("message"),
    z.literal("closedate"),
    z.literal("hs_analytics_average_page_views"),
    z.literal("hs_email_replied"),
    z.literal("hs_analytics_revenue"),
    z.literal("hs_lifecyclestage_lead_date"),
    z.literal("hs_lifecyclestage_marketingqualifiedlead_date"),
    z.literal("hs_lifecyclestage_opportunity_date"),
    z.literal("lifecyclestage"),
    z.literal("hs_lifecyclestage_salesqualifiedlead_date"),
    z.literal("createdate"),
    z.literal("hs_lifecyclestage_evangelist_date"),
    z.literal("hs_lifecyclestage_customer_date"),
    z.literal("hubspotscore"),
    z.literal("company"),
    z.literal("hs_lifecyclestage_subscriber_date"),
    z.literal("hs_lifecyclestage_other_date"),
    z.literal("website"),
    z.literal("numemployees"),
    z.literal("annualrevenue"),
    z.literal("industry"),
    z.literal("associatedcompanyid"),
    z.literal("associatedcompanylastupdated"),
    z.literal("hs_predictivecontactscorebucket"),
    z.literal("hs_predictivecontactscore"),
  ]),
  z.literal(true),
);
