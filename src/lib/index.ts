...
type F = <Name extends COLLECTION_NAMES>(arg: CollHelperInternalArgs<Name>) => any
...
type ArrayMergeHelper2<Result extends Record<string, any>, LL extends readonly F[]> = LL extends readonly [infer Head extends F, ...infer Rest extends F[]] ? ArrayMergeHelper2<Result & ReturnType<Head>, Rest> : Result