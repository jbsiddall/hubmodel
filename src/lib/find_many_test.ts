...
import { assertSpyCall, assertSpyCalls, returnsNext, stub } from "https://deno.land/std@0.201.0/testing/mock.ts";
...
Deno.test(async function select() {
  ...
  assertEquals(contacts, [
    {
      ...
      "createdAt": new Date("2023-09-15T23:36:11.779Z"),
      "updatedAt": new Date("2023-09-15T23:36:11.779Z"),
      "archived": false,
    },
  ]);
});
